...
bool PhysicsMaybeApp::startup() {
	...
	Box* box1;
	box1 = new Box(glm::vec2(-25, 10), glm::vec2(2.5, 2.5), glm::vec2(0, 0), 25.0f, true, 0.5f, 0.8f, 0.0f, glm::vec4(1, 0, 0, 1));
	m_physicsScene->addActor(box1);

	Box* box3;
	box3 = new Box(glm::vec2(-52, 10), glm::vec2(2.5, 2.5), glm::vec2(0, 0), 25.0f, true, 0.5f, 0.8f, 0.0f, glm::vec4(1, 0, 0, 1));
	m_physicsScene->addActor(box3);
	
	Box* box2;
	box2 = new Box(glm::vec2(-50, 25), glm::vec2(2.5f, 2.5f), glm::vec2(0, 0), 15.625f, false, 0.5f, 0.8f, 0.0f, glm::vec4(1, 0, 0, 1));
	...
	Plane* plane2;
	plane2 = new Plane(glm::vec2(0, 1), -30);
	...
	float ballRadius = 2; 
	float mass = 1; 
	ball1 = new Sphere(glm::vec2(startX, 40), glm::vec2(0, 0), mass, false, ballRadius, 0.5f, 0.2f, 1.0f, glm::vec4(1, 1, 1, 1));
	...
	{
		ball2 = new Sphere(glm::vec2(startX + i * 6.0f, 40), 0, 0, mass, false, ballRadius, 0.5f, 0.2f, 1.0f, glm::vec4(1, 1, 1, 1));
